...
" Undofileの出力先
set undodir=c:/@mydata/20_appdata/vim

" swapファイルの出力先
set directory=c:/@mydata/20_appdata/vim

" 初期カレントディレクトリ
set browsedir=C:/@MyData/20_appdata/kami
...
let $KAMIDIR = 'C:/@MyData/20_AppData/kami/標準'
